    var gulp       = require('gulp'), // Подключаем Gulp
        ...
        del          = require('del'), //библиотеку для удаления файлов и папок
        imagemin     = require('gulp-imagemin'), //библиотеку для работы с изображениями
        pngquant     = require('imagemin-pngquant'), //библиотеку для работы с png
        cache        = require('gulp-cache'), //библиотеку кеширования
        autoprefixer = require('gulp-autoprefixer');//библиотеку для автоматического добавления префиксов
    ...
    gulp.task('scripts', function() {
        return gulp.src([ // Берем все необходимые библиотеки
            'app/lib/angular/angular.min.js', // Берем Angular
			'app/lib/bootstrap/css/bootstrap.css',// Берем Bootstrap
              ])
    ...
    gulp.task('img', function() {
        return gulp.src('app/img/**/*') // Берем все изображения из app
            .pipe(cache(imagemin({  // Сжимаем их с учетом кеширования
                interlaced: true,
                progressive: true,
